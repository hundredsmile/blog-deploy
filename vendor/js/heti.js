(function (global, factory) {
    ...
    class Heti {
      ...
      spacingElement ($$elm) {
        ...
        // const addSpaceBefore = function (elementName, classList, text) {
        //     const $$h = document.createElement("heti-char");
        //     const $$r = document.createElement("heti-ws");
        //     $$r.textContent = " ";
        //     $$h.appendChild($$r);
        //     $$h.appendChild(getWrapper(elementName, classList, text));
        //     return $$h
        // };
        // const addSpaceAfter = function (elementName, classList, text) {
        //     const $$h = document.createElement("heti-char");
        //     const $$r = document.createElement("heti-ws");
        //     $$r.textContent = " ";
        //     $$h.appendChild(getWrapper(elementName, classList, text));
        ...
        //     return $$h
        // };
        const addSpaceBeforePlain = function (text) {
            const $$h = document.createElement("heti-char");
            const $$r = document.createElement("heti-ws");
            $$r.textContent = " ";
            $$h.appendChild($$r);
            $$h.innerHTML += text.trim();
            return $$h
        };
        const addSpaceAfterPlain = function (text) {
            const $$h = document.createElement("heti-char");
            const $$r = document.createElement("heti-ws");
            $$r.textContent = " ";
        ...
        // 替换单一出现的标点
        findAndReplaceDOMText($$elm, Object.assign({}, commonConfig, {
          find: new RegExp(`[${REG_BD_OPEN}]`, 'g'),
          replace: portion => addSpaceBeforePlain(portion.text),
          // offset: this.offsetWidth,
          filterElements: function(el) {return !(el.matches('heti-char'))}
        }));

        findAndReplaceDOMText($$elm, Object.assign({}, commonConfig, {
          find: new RegExp(`[${REG_BD_CLOSE}]|[${REG_BD_STOP}]`, 'g'),
          replace: portion => addSpaceAfterPlain(portion.text),
          // offset: this.offsetWidth,
          filterElements: function(el) {return !(el.matches('heti-char'))}
        }));

        // 在单一标点前后加入空格，自动行首和行尾挤压
        findAndReplaceDOMText($$elm, Object.assign({}, commonConfig, {
          find: new RegExp(`[${REG_BD_OPEN}]`, 'g'),
          replace: portion => getWrapper('heti-punct', 'heti-punct-left', portion.text),
          // offset: this.offsetWidth,
        }));

        findAndReplaceDOMText($$elm, Object.assign({}, commonConfig, {
          find: new RegExp(`[${REG_BD_CLOSE}]|[${REG_BD_STOP}]`, 'g'),
          replace: portion => getWrapper('heti-punct', 'heti-punct-right', portion.text),
          // offset: this.offsetWidth,
        }));
      }
